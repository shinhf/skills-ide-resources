...
The agent uses the plugin skill `architecture-mapping` for the subject matter and the dialogue protocol in `${CLAUDE_PLUGIN_ROOT}/skills/socratic-dialogue/SKILL.md` for the shape of every turn, and inherits the `mentor-guidance` rules. Enforce:
